...
export class AddedChatEntities1774203885060 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chat_member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "unreadCount" integer NOT NULL DEFAULT '0', "lastReadAt" TIMESTAMP, "role" character varying NOT NULL DEFAULT 'member', "userUid" character varying, "chatId" uuid, CONSTRAINT "PK_2aad8c13481bba9b43eaa2a774f" PRIMARY KEY ("id"))`);
