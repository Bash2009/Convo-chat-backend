...
export class ModifiedChatEntities1776603372719 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" DROP CONSTRAINT "REL_d96167b8ced25dc5253247fd34"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "message" ADD "status" character varying NOT NULL DEFAULT 'sent'`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "avatarUrl" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "lastMessageText" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" ADD CONSTRAINT "REL_d96167b8ced25dc5253247fd34" UNIQUE ("lastMessageId")`,
    );
    await queryRunner.query(
